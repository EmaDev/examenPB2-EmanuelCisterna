...
public class Extraccion extends Transaccion implements Rechazable, Alertable{	


	public Extraccion(String idTransaccion, Cliente cliente, Dispositivo dispositivo) {
	...
	public Boolean monitorear(Monitoreador monitoreador) throws FraudeException {
		...
		if(getScore() > 80) {
			throw new FraudeException("Esta extraccion es fraudulenta");
		}
		return true;
	}
